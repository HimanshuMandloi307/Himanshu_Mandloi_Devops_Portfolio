        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CLOUD</h3>
              <h4>AWS Infrastructure & Architecture</h4>
              <p>
                Designing and managing scalable cloud infrastructure on AWS.
                Building secure, highly available environments using VPC, EC2,
                Load Balancers, and Kubernetes (EKS).
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">ALB</div>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS</h3>
              <h4>CI/CD & Infrastructure Automation</h4>
              <p>
                Automating application deployments using CI/CD pipelines,
                containerization with Docker, and Kubernetes orchestration.
                Implementing Infrastructure as Code and GitOps workflows.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
